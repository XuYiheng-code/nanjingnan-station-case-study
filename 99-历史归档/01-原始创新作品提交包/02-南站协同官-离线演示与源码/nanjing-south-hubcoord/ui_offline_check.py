...
with sync_playwright() as playwright:
    ...
    for filename in PAGES:
        ...
        if filename == "index.html":
            ...
            expect(page.locator(".site-nav a")).to_have_count(6)
    ...
    expect(overview.locator(".route-grid > a")).to_have_count(5)
    ...
    expect(page.locator("#heroTitle")).to_contain_text("亲手完成一次")
    ...
    expect(mobile.locator(".site-nav a")).to_have_count(6)
    ...
    expect(mobile.locator(".top-nav a")).to_have_count(6)
